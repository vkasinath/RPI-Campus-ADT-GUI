...
public class CampusPathsTest { // Rename to the name of your "main" class
	...
	@Test
	public void testIDName() throws IOException {
		runTest("hw7TestIDName");
	}
	
	@Test
	public void testNameID() throws IOException {
		runTest("hw7TestNameID");
	}
	
	@Test
	public void testNameName() throws IOException {
		runTest("hw7TestNameName");
	}
	...
	public void testCompare1() throws IOException {
		compare("data/hw7TestMUQ.test", "data/hw7TestCompare.test");
	}
	
	@Test
	public void testCompare2() throws IOException {
		compare("data/hw7TestNull.test", "data/hw7TestMUQ.test");
	}
	
	@Test
	public void testCompare3() throws IOException {
		compare("data/hw7TestMUQ.test", "data/hw7TestNull.test");
	}
